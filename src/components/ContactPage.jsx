...
export default function ContactPage({ onNavigate, onOpenLegal }) {
  ...
  return (
    <div className="relative min-h-[calc(100vh-70px)] w-full bg-slate-950 text-slate-100 flex flex-col justify-center items-center py-4 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div className="relative w-full max-w-5xl flex flex-col gap-3.5 my-auto">
        ...
        <div className="text-center">
          ...
          <h1 className="font-teko text-3xl sm:text-4xl font-black uppercase tracking-wide text-white leading-none">
        ...
        {/* 2-Column Clean Unified Card Grid */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 items-stretch">
          
          {/* LEFT CARD: Contact Channels, Hours & Socials */}
          <div className="rounded-2xl border border-slate-800/90 bg-slate-900/60 p-4 sm:p-5 backdrop-blur-xl shadow-xl flex flex-col justify-between gap-3.5">
            ...
            <div className="space-y-2">
              ...
              <a
                ...
                className="group flex items-center justify-between rounded-xl border border-slate-800/80 bg-slate-950/60 p-2.5 transition-all duration-300 hover:border-orange-500/50 hover:bg-slate-900/90 active:scale-[0.99]"
              >
                <div className="flex items-center gap-3">
                  <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-orange-500/15 border border-orange-500/30 text-orange-400 group-hover:bg-orange-500 group-hover:text-white transition-colors">
                    <Phone className="h-4 w-4" />
                  </div>
                  <div>
                    <div className="text-[10px] font-medium uppercase text-slate-400 leading-none">Direct Phone</div>
                    <div className="font-teko text-lg font-bold text-white group-hover:text-orange-400 transition-colors leading-tight">
                      {phoneDisplay}
                    </div>
                  </div>
                </div>
              ...
              <a
                ...
                className="group flex items-center justify-between rounded-xl border border-slate-800/80 bg-slate-950/60 p-2.5 transition-all duration-300 hover:border-emerald-500/50 hover:bg-slate-900/90 active:scale-[0.99]"
              >
                <div className="flex items-center gap-3">
                  <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-emerald-500/15 border border-emerald-500/30 text-emerald-400 group-hover:bg-[#25D366] group-hover:text-white transition-colors">
                    <WhatsAppIcon className="h-4 w-4" />
                  </div>
                  <div>
                    <div className="text-[10px] font-medium uppercase text-slate-400 leading-none">WhatsApp Support</div>
                    <div className="font-teko text-lg font-bold text-white group-hover:text-emerald-400 transition-colors leading-tight">
                      Chat with Trainer
                    </div>
                  </div>
                </div>
                <span className="text-[10px] text-slate-400 bg-slate-800/60 border border-slate-700/60 px-2 py-0.5 rounded-full flex items-center gap-1">
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="font-mono text-xs font-bold text-white group-hover:text-orange-400 transition-colors leading-tight">
                      support@gymnation.com
                    </div>
                  </div>
                </div>
                <span className="text-[10px] text-slate-400 bg-slate-800/60 border border-slate-700/60 px-2 py-0.5 rounded-full">
                  Official
                </span>
              </a>
            </div>
            ...
            <div className="rounded-xl border border-slate-800/80 bg-slate-950/40 p-2.5">
              ...
              <div className="grid grid-cols-2 gap-2 text-[11px]">
                <div className="flex items-center justify-between rounded-lg bg-slate-900/80 border border-slate-800/80 px-2.5 py-1">
                  <span className="text-slate-300 font-medium">Morning</span>
                  <span className="font-mono text-orange-400 font-bold text-[10px]">6:00 AM - 1:00 PM</span>
                </div>
                <div className="flex items-center justify-between rounded-lg bg-slate-900/80 border border-slate-800/80 px-2.5 py-1">
                  <span className="text-slate-300 font-medium">Evening</span>
            ...
            <div className="flex items-center justify-between gap-2 pt-1 border-t border-slate-800/60">
              <div className="flex items-center gap-2">
                <img src={logoImg} alt="Gymnation" className="h-6 w-auto" />
              ...
              <div className="flex items-center gap-1.5">
                {socials.map(({ label, href, Icon, color, borderColor }) => (
                  <a
                    ...
                    title={label}
                    aria-label={label}
                    className={`flex h-7 w-7 items-center justify-center rounded-lg border border-slate-800 bg-slate-950/80 transition-all duration-300 hover:scale-110 active:scale-95 ${borderColor} ${color}`}
                  >
          ...
          <div className="rounded-2xl border border-slate-800/90 bg-slate-900/60 p-4 sm:p-5 backdrop-blur-xl shadow-xl flex flex-col justify-between gap-3.5">
            ...
            <div>
              ...
              <div className="mt-2 flex items-start justify-between gap-2 text-[11px] bg-slate-950/60 rounded-xl p-2 border border-slate-800/80">
                ...
                <span className="text-[9px] text-slate-400 bg-slate-900 px-1.5 py-0.5 rounded border border-slate-800 shrink-0 font-medium self-center">
                  Free Parking
                </span>
              </div>
            </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-1.5">
                  <div className="grid grid-cols-2 gap-1.5">
                    <input
                      ...
                      className="w-full rounded-lg border border-slate-800 bg-slate-900/80 px-2.5 py-1 text-[11px] text-slate-100 placeholder:text-slate-500 focus:border-orange-500 focus:outline-none transition-colors"
                    />
                    <input
                      type="tel"
                  ...
                  <div className="flex gap-1.5">
                    <input
                      ...
                      className="min-w-0 flex-1 rounded-lg border border-slate-800 bg-slate-900/80 px-2.5 py-1 text-[11px] text-slate-100 placeholder:text-slate-500 focus:border-orange-500 focus:outline-none transition-colors"
                    />
                    <button
                      type="submit"
                      disabled={isSubmitting}
                      className="shrink-0 flex items-center justify-center gap-1 rounded-lg bg-gradient-to-r from-orange-500 to-amber-500 px-3.5 py-1 text-[10px] font-black uppercase tracking-wider text-white shadow transition-all hover:shadow-[0_0_15px_rgba(249,115,22,0.4)] active:scale-[0.98] disabled:opacity-50 cursor-pointer"
                    >
                      {isSubmitting ? (
        ...
        {/* Clean Footer Row */}
        <div className="pt-2 border-t border-slate-800/60 flex flex-col sm:flex-row items-center justify-between gap-2 text-[10px] text-slate-500">
